...
const checks = [
  ...
  [pageSitemapProvider.includes("'orderby' => array( 'modified' => 'DESC', 'ID' => 'DESC' )"), "Workflow page sitemap pagination must use ID as a deterministic final tie-break."],
  [pageSitemapProvider.includes("new WP_Query"), "The stable provider must use WordPress's native query Interface instead of duplicating Rank Math SQL."],
